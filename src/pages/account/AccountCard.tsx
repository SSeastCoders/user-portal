      ...
      <div className="card-body">
        <Link to={{
          ...
          <div className="tw-flex tw-justify-between">
            <div className="tw-flex">
              <span className="tw-mr-2">
                <svg width="42px" height="34px" x="0px" y="0px" viewBox="0 0 42 34" aria-hidden="true" role="img" focusable="false">
                  <g>
                    <path fill="#D3D3D3" d="M0,4.5v20h4v3.817c0,1.231,0.56,1.996,1.461,1.996h16.762c0.963,0,1.776-0.914,1.776-1.996V24.5h18v-20H0z
          ...
          c0.001,0.471,0.541,0.792,1.826,1.243c1.812,0.611,2.372,1.417,2.377,2.755C37.324,17.262,36.75,18.368,34.5,18.668z">
                    ...
                    <rect x="18" y="24.5" fill="#D3D3D3" width="3" height="2"></rect>
                    <rect x="6" y="24.5" fill="#D3D3D3" width="10" height="1"></rect>
                  </g>
                </svg>
              </span>
              <span className="tw-text-lg">{account.nickName} {account.accountType}</span>
            </div>
