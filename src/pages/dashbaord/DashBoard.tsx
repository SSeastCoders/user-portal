  ...
  return (
    <AccountsBarContext.Provider value={setDisabled}>
      <div className="wrapper">
        ...
        <SideBar></SideBar>
        <Navbar
          className={classNames('main-header tw-z-0', disabled && 'tw-hidden')}
          bg="primary"
        >
          <NavLink
            className="hover:tw-bg-linkhover"
            as={Link}
            to="/dashboard/overviewAccounts"
          >
            Accounts
          </NavLink>
        ...
        <Switch>
          ...
          <PrivateRoute exact path="/dashboard/accountOpening">
            <OpenAccount></OpenAccount>
          </PrivateRoute>
          <PrivateRoute exact path="/dashboard/accountOpening/accountType">
            <AccountRegistration></AccountRegistration>
          </PrivateRoute>
          <PrivateRoute exact path="/dashboard/overviewAccounts">
            <AccountCardList></AccountCardList>
          </PrivateRoute>
          <PrivateRoute
            exact
            path="/dashboard/overviewAccounts/overview/account"
          >
